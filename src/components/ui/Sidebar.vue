      ...
      <div v-else class="relative flex items-center flex-1 justify-between min-w-0 gap-2">
        ...
        >
          <div class="flex items-center gap-1.5 min-w-0">
            ...
            <span class="font-black text-[15px] text-amber-800 dark:text-amber-400 font-apple-body-strong tracking-tight"> Kakao </span>
            <CocoaPodIcon class="w-4 h-4 text-amber-800 dark:text-amber-400 shrink-0" />
          </div>
